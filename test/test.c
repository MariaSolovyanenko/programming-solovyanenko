...
#define DATA_SIZE 6
	...
	enum animal_type input_data[] = { CAT, HUMEN, DOG, COW, ANIMAL_TYPE_COUNT, ANIMAL_TYPE_COUNT + 1 };
	char *expected_values[] = { "Кіт", "Людина", "Собака", "Корова", "N/A", "N/A" };
